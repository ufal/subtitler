...
var logTime = function(element) {
  console.log(element.dataset.emissionTime
...
var Viewer = {
  ...
  processUpdate: function(change) {
    // NOT IMPLEMENTED YET
    // -- each update command can be replaced by a pair (remove, insert)
    // -- can be later implemented for better performance, if necessary
    throw Error("Change type 'UPDATE' is not implemented.")
  },
  ...
  refresh: function() {
    ...
    if (cf.logSpeed) console.log(cf.readingSpeed);
